...
function Sidebar(props) {
    ...
    return (
        <div className={` sidebar transition-all duration-300 relative top-0 left-0 pt-4 ${collapsed ? "w-[80px]" : "w-[230px]"}`}>
            <div className="absolute right-[-20px] top-72 rounded-full justify-center items-center w-10 h-10 flex z-40 shadow-md bg-white"
